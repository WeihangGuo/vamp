...
namespace vamp::robots
{
    struct Panda
    {
            ...
            const ConfigurationBlock<rake> &x) noexcept -> Debug
        {
            ...
            y[268] = -2.68202932503632e-18 * v[53] + -2.76815702477656e-18 * v[42] +
                     0.129201397299767 * v[37] + v[29];
            y[269] = -2.68202932503632e-18 * v[56] + -2.76815702477656e-18 * v[31] +
                     0.129201397299767 * v[45] + v[46];
            y[270] = -2.68202932503632e-18 * v[52] + -2.76815702477656e-18 * v[55] +
            ...
            const ConfigurationBlock<rake> &x) noexcept
        {
            ...
            y[268] = -2.68202932503632e-18 * v[50] + -2.76815702477656e-18 * v[42] +
                     0.129201397299767 * y[289] + v[37];
            y[269] = -2.68202932503632e-18 * v[53] + -2.76815702477656e-18 * v[29] +
                     0.129201397299767 * y[290] + v[31];
            y[270] = -2.68202932503632e-18 * v[49] + -2.76815702477656e-18 * v[52] +
        ...
        template <std::size_t rake>
        inline static auto
        sdf(const vamp::collision::Environment<FloatVector<rake>> &environment,
            const ConfigurationBlock<rake> &x) noexcept -> std::array<FloatVector<rake>, 59>
        {
            std::array<FloatVector<rake, 1>, 57> v;
            std::array<FloatVector<rake, 1>, 280> y;
            ...
            std::array<FloatVector<rake>, 59> dists;

            dists[0] = vamp::sphere_environment_signed_distance(environment, y[0], y[1], y[2], y[3]);

            dists[1] = vamp::sphere_environment_signed_distance(environment, y[4], y[5], y[6], y[7]);

            dists[2] = vamp::sphere_environment_signed_distance(environment, y[8], y[9], y[10], y[11]);

            dists[3] = vamp::sphere_environment_signed_distance(environment, y[12], y[13], y[14], y[15]);

            dists[4] = vamp::sphere_environment_signed_distance(environment, y[16], y[17], y[18], y[19]);

            dists[5] = vamp::sphere_environment_signed_distance(environment, y[20], y[21], y[22], y[23]);

            dists[6] = vamp::sphere_environment_signed_distance(environment, y[24], y[25], y[26], y[27]);

            dists[7] = vamp::sphere_environment_signed_distance(environment, y[28], y[29], y[30], y[31]);

            dists[8] = vamp::sphere_environment_signed_distance(environment, y[32], y[33], y[34], y[35]);

            dists[9] = vamp::sphere_environment_signed_distance(environment, y[36], y[37], y[38], y[39]);

            dists[10] = vamp::sphere_environment_signed_distance(environment, y[40], y[41], y[42], y[43]);

            dists[11] = vamp::sphere_environment_signed_distance(environment, y[44], y[45], y[46], y[47]);

            dists[12] = vamp::sphere_environment_signed_distance(environment, y[48], y[49], y[50], y[51]);

            dists[13] = vamp::sphere_environment_signed_distance(environment, y[52], y[53], y[54], y[55]);

            dists[14] = vamp::sphere_environment_signed_distance(environment, y[56], y[57], y[58], y[59]);

            dists[15] = vamp::sphere_environment_signed_distance(environment, y[60], y[61], y[62], y[63]);

            dists[16] = vamp::sphere_environment_signed_distance(environment, y[64], y[65], y[66], y[67]);

            dists[17] = vamp::sphere_environment_signed_distance(environment, y[68], y[69], y[70], y[71]);

            dists[18] = vamp::sphere_environment_signed_distance(environment, y[72], y[73], y[74], y[75]);

            dists[19] = vamp::sphere_environment_signed_distance(environment, y[76], y[77], y[78], y[79]);

            dists[20] = vamp::sphere_environment_signed_distance(environment, y[80], y[81], y[82], y[83]);

            dists[21] = vamp::sphere_environment_signed_distance(environment, y[84], y[85], y[86], y[87]);

            dists[22] = vamp::sphere_environment_signed_distance(environment, y[88], y[89], y[90], y[91]);

            dists[23] = vamp::sphere_environment_signed_distance(environment, y[92], y[93], y[94], y[95]);

            dists[24] = vamp::sphere_environment_signed_distance(environment, y[96], y[97], y[98], y[99]);

            dists[25] = vamp::sphere_environment_signed_distance(environment, y[100], y[101], y[102], y[103]);

            dists[26] = vamp::sphere_environment_signed_distance(environment, y[104], y[105], y[106], y[107]);

            dists[27] = vamp::sphere_environment_signed_distance(environment, y[108], y[109], y[110], y[111]);

            dists[28] = vamp::sphere_environment_signed_distance(environment, y[112], y[113], y[114], y[115]);

            dists[29] = vamp::sphere_environment_signed_distance(environment, y[116], y[117], y[118], y[119]);

            dists[30] = vamp::sphere_environment_signed_distance(environment, y[120], y[121], y[122], y[123]);

            dists[31] = vamp::sphere_environment_signed_distance(environment, y[124], y[125], y[126], y[127]);

            dists[32] = vamp::sphere_environment_signed_distance(environment, y[128], y[129], y[130], y[131]);

            dists[33] = vamp::sphere_environment_signed_distance(environment, y[132], y[133], y[134], y[135]);

            dists[34] = vamp::sphere_environment_signed_distance(environment, y[136], y[137], y[138], y[139]);

            dists[35] = vamp::sphere_environment_signed_distance(environment, y[140], y[141], y[142], y[143]);

            dists[36] = vamp::sphere_environment_signed_distance(environment, y[144], y[145], y[146], y[147]);

            dists[37] = vamp::sphere_environment_signed_distance(environment, y[148], y[149], y[150], y[151]);

            dists[38] = vamp::sphere_environment_signed_distance(environment, y[152], y[153], y[154], y[155]);

            dists[39] = vamp::sphere_environment_signed_distance(environment, y[156], y[157], y[158], y[159]);

            dists[40] = vamp::sphere_environment_signed_distance(environment, y[160], y[161], y[162], y[163]);

            dists[41] = vamp::sphere_environment_signed_distance(environment, y[164], y[165], y[166], y[167]);

            dists[42] = vamp::sphere_environment_signed_distance(environment, y[168], y[169], y[170], y[171]);

            dists[43] = vamp::sphere_environment_signed_distance(environment, y[172], y[173], y[174], y[175]);

            dists[44] = vamp::sphere_environment_signed_distance(environment, y[176], y[177], y[178], y[179]);

            dists[45] = vamp::sphere_environment_signed_distance(environment, y[180], y[181], y[182], y[183]);

            dists[46] = vamp::sphere_environment_signed_distance(environment, y[184], y[185], y[186], y[187]);

            dists[47] = vamp::sphere_environment_signed_distance(environment, y[188], y[189], y[190], y[191]);

            dists[48] = vamp::sphere_environment_signed_distance(environment, y[192], y[193], y[194], y[195]);

            dists[49] = vamp::sphere_environment_signed_distance(environment, y[196], y[197], y[198], y[199]);

            dists[50] = vamp::sphere_environment_signed_distance(environment, y[200], y[201], y[202], y[203]);

            dists[51] = vamp::sphere_environment_signed_distance(environment, y[204], y[205], y[206], y[207]);

            dists[52] = vamp::sphere_environment_signed_distance(environment, y[208], y[209], y[210], y[211]);

            dists[53] = vamp::sphere_environment_signed_distance(environment, y[212], y[213], y[214], y[215]);

            dists[54] = vamp::sphere_environment_signed_distance(environment, y[216], y[217], y[218], y[219]);

            dists[55] = vamp::sphere_environment_signed_distance(environment, y[220], y[221], y[222], y[223]);

            dists[56] = vamp::sphere_environment_signed_distance(environment, y[224], y[225], y[226], y[227]);

            dists[57] = vamp::sphere_environment_signed_distance(environment, y[228], y[229], y[230], y[231]);

            dists[58] = vamp::sphere_environment_signed_distance(environment, y[232], y[233], y[234], y[235]);
        ...
        inline static auto sdf_gradient(
            const vamp::collision::Environment<FloatVector<rake>> &environment,
            const ConfigurationBlock<rake> &x) noexcept
            -> std::pair<std::array<FloatVector<rake>, 59>, std::array<FloatVector<rake>, 59 * 3>>
        {
            std::array<FloatVector<rake, 1>, 57> v;
            std::array<FloatVector<rake, 1>, 280> y;
            ...
            std::array<FloatVector<rake>, 59> dists;
            std::array<FloatVector<rake>, 59 * 3> grads;
        ...
        inline static void d_collision_d_q(
            const std::array<float, 7> &q_in,
            const std::array<float, 59 * 3> &gradients,
            std::array<float, 7> &out) noexcept
        {
            // Generated code expects a single input array 'x' containing
            // [q_0, ..., q_n, gx_0, gy_0, gz_0, ..., gx_m, gy_m, gz_m]
            // NOTE: The generated code seems to expect 70 spheres (max index 216 = 7 + 70*3 - 1),
            // but we only have 59. We pad with zeros.
            std::array<float, 7 + 70 * 3> x;
            x.fill(0.0f);
            ...
            v[51] =
                -2.68202932503632e-18 * v[143] + -2.76815702477656e-18 * v[133] + 0.129201397299767 * v[134];
            v[48] =
                -2.68202932503632e-18 * v[147] + -2.76815702477656e-18 * v[136] + 0.129201397299767 * v[137];
            ...
            v[121] =
                -2.68202932503632e-18 * v[142] + -2.76815702477656e-18 * v[122] + 0.129201397299767 * v[118];
